...
export const getPingQueryOptions = <TData = Awaited<ReturnType<typeof ping>>, TError = ApiError>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof ping>>, TError, TData>>, }
) => {
...
export function usePing<TData = Awaited<ReturnType<typeof ping>>, TError = ApiError>(
